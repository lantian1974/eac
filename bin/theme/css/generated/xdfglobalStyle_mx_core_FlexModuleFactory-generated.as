...
public class xdfglobalStyle_mx_core_FlexModuleFactory
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function xdfglobalStyle_mx_core_FlexModuleFactory()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "xdfglobalStyle" : String(params[0]);
...
,
            ...
            compiledResourceBundleNames: [ "core", "effects", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "xdfglobalStyle",
            mixins: [ "_xdfglobalStyle_Styles" ],
            placeholderRsls: [
