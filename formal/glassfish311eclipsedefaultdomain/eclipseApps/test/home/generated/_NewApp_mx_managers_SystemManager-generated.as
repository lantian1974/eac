...
public class _NewApp_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _NewApp_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "NewApp" : String(params[0]);
...
"",
"37a6ce2e121d7aa2f49aabdf296379fcce909a1607d8b0dfbd7a1aa7e3522edb",
"SHA-256",false,false,"default")],
...
,
            ...
            compiledResourceBundleNames: [ "collections", "components", "containers", "controls", "core", "effects", "layout", "logging", "messaging", "rpc", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "NewApp",
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_NewApp_FlexInit", "_NewApp_Styles", "RemotingConfigIni", "mx.messaging.config.LoaderConfig", "mx.managers.systemClasses.ActiveWindowManager" ],
            placeholderRsls: [
