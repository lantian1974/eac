...
public class _MainApp_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _MainApp_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "MainApp" : String(params[0]);
...
,
            ...
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_MainApp_FlexInit", "_MainApp_Styles", "mx.messaging.config.LoaderConfig", "mx.managers.systemClasses.ActiveWindowManager" ],
            placeholderRsls: [
