 ...
 **/
    ...
    public function MainApp()
    {
        ...
        _MainApp_HTTPService1_i();
        _MainApp_RemoteObject1_i();


        // events
        this.addEventListener("applicationComplete", ___MainApp_Application1_applicationComplete);
    ...
    //  <Script>, line 11 - 34
			...
			private function configResultHandler(event:ResultEvent):void
			{
				...
				var amfEndpoint:String = "" + xml..channel.(@id=="my-amf").@endpointUrl;
				if (amfEndpoint == "")
				{
...
private function _MainApp_HTTPService1_i() : mx.rpc.http.mxml.HTTPService
{
	var temp : mx.rpc.http.mxml.HTTPService = new mx.rpc.http.mxml.HTTPService();
	temp.url = "FlexChannelsConfig";
	temp.resultFormat = "e4x";
	temp.addEventListener("result", __configSrv_result);
	temp.initialized(this, "configSrv")
	configSrv = temp;
	mx.binding.BindingManager.executeBindings(this, "configSrv", configSrv);
	return temp;
}
 ...
 * @private
 **/
public function __configSrv_result(event:mx.rpc.events.ResultEvent):void
{
	configResultHandler(event)
}
 ...
 * @private
 **/
public function ___MainApp_Application1_applicationComplete(event:mx.events.FlexEvent):void
{
	configSrv.send()
}
