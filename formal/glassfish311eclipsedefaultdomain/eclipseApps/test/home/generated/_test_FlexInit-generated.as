           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         ...
                         ["mx.collections.ArrayCollection","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.collections.ArrayList","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.config.ConfigMap","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AcknowledgeMessage","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AcknowledgeMessageExt","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AsyncMessage","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.AsyncMessageExt","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.CommandMessage","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.CommandMessageExt","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.ErrorMessage","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.MessagePerformanceInfo","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.messaging.messages.RemotingMessage","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.utils.ObjectProxy","test","_test_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
