...
public class _TestChannelConfigManager_mx_managers_SystemManager
    ...
    implements IFlexModuleFactory, ISWFContext
{
    ...
    public function _TestChannelConfigManager_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "TestChannelConfigManager" : String(params[0]);
...
"SHA-256",false,false,"default")],
[new RSLData("epmr_facility_flex.swf",
"",
"ea12b535a2a57ab6614d6b253109d40b58e3fd514fc2ddd62161713cafe038b3",
"SHA-256",false,false,"default")],
]
,
            compiledLocales: [ "en_US" ],
            compiledResourceBundleNames: [ "collections", "components", "core", "effects", "layout", "logging", "messaging", "skins", "sparkEffects", "styles", "textLayout" ],
            creationComplete: "doInitialize()",
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "TestChannelConfigManager",
            minHeight: "600",
            minWidth: "955",
            mixins: [ "_TestChannelConfigManager_FlexInit", "_TestChannelConfigManager_Styles", "mx.messaging.config.LoaderConfig" ],
            placeholderRsls: [
