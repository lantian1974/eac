package org.epmr.utils.xmltools
{
	...
	public class XmlTemplate
	{
	    ...
	    */
	    private function convertAllPlaceholder():void
	    {
	    ...
	    *设置模板。
	    template: XML模板。
	    * */
	    public function setTemplate(template:XML):void
	    {
	    	this.template=template.toXMLString();
	    ...
	    /**
	      设置变量的开始开占占位符
	    * */
	    public function setBeginPlaceholder(beginPlaceholder:String):void
	    {
	    	this.beginPlaceholder=beginPlaceholder;
	    ...
	    /**
	     设置变量的结束占位符
	    */
	    public function setEndPlaceholder(endPlaceholder:String):void
	    {
	    ...
	    * */
		...
		public function getInstance(paramObj:Object):XML
		{
				...
				var xmlStr:String=this.template;
